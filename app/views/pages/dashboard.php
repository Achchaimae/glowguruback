...
<body>
    <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
                ...
                <div class="text-white">
                    <div class="flex p-2  bg-gray-800">
                        <div class="flex py-3 px-2 items-center">
                            <img src="<?= URLROOT ?>/img/logo.png" class="w-18" alt="">
                        </div>
                    </div>
                    ...
                    <div>
                        <ul class="mt-6 leading-10">
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-cyan-700" href="Dashboard">
                            ...
                            <li class="relative px-2 py-1" x-data="{ Open : false  }">
                                <div class="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer" x-on:click="Open = !Open">
                                    <span class="inline-flex items-center  text-sm font-semibold text-white hover:text-cyan-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300" x-transition:enter-start="opacity-25 max-h-0" x-transition:enter-end="opacity-100 max-h-xl" x-transition:leave="transition-all ease-in-out duration-300" x-transition:leave-start="opacity-100 max-h-xl" x-transition:leave-end="opacity-0 max-h-0" class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium  rounded-md shadow-inner  bg-cyan-700" aria-label="submenu">
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <button class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800 " onclick="show()">Products</button>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
            ...
            <div>
                <div class="text-white">
                    ...
                    <div>
                        <ul class="mt-6 leading-10">
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-cyan-700" href=" #">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                                    </svg>
                                    <span class="ml-4">DASHBOARD</span>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <button class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800" onclick="show()">Products
                                                    </button>
                                                </div>
                                            </div>
                                        </li>
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto">
            <header class="z-40 py-4  bg-gray-800  ">
                <div class="flex items-center justify-between h-8 px-6 mx-auto">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6 flex-end ">
                        ...
                        <!-- Notifications menu -->
                        <li class="relative">
                            <button class="p-2 bg-white text-cyan-700 align-middle rounded-full hover:text-white hover:bg-cyan-700 focus:outline-none " @click="toggleNotificationsMenu" @keydown.escape="closeNotificationsMenu" aria-label="Notifications" aria-haspopup="true">
                        ...
                        <!-- Profile menu -->
                        <li class="relative">
                            <button class="p-2 bg-white text-cyan-700 align-middle rounded-full hover:text-white hover:bg-cyan-700 focus:outline-none " @click="toggleProfileMenu" @keydown.escape="closeProfileMenu" aria-label="Account" aria-haspopup="true">
                                <div class="flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <template x-if="isProfileMenuOpen">
                                <ul x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0" @click.away="closeProfileMenu" @keydown.escape="closeProfileMenu" class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-cyan-700 border border-cyan-700 rounded-md shadow-md" aria-label="submenu">
                                    <li class="flex">
                                    ...
                                    <li class="flex">
                                        <a class="text-white inline-flex items-center w-full px-2 py-1 text-sm font-semibold transition-colors duration-150 rounded-md hover:bg-gray-100 hover:text-gray-800" href=" <?php echo URLROOT; ?>/Autho/logout">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <main class="">
                <div class="grid mb-4 pb-10 px-8 mx-4 rounded-3xl bg-gray-100 border-4 text-cyan-700">
                        ...
                        <div class="grid grid-cols-12 col-span-12 gap-6 xxl:col-span-9">
                            <div class="col-span-12 mt-8">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white" href="#">
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div class="bg-cyan-700 rounded-full h-6 px-2 flex justify-items-center text-white font-semibold text-sm">
                                    ...
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white" href="#">
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-cyan-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div class="col-span-12 mt-5">
                                <div class="grid gap-2 grid-cols-1 lg:grid-cols-1">
                                    <!-- product table -->
                                    <div class="bg-white p-4 shadow-lg rounded-lg invisible" id="stat">
                                        <div class="mt-4">
                                                                    ...
                                                                    <tbody class="bg-white divide-y divide-gray-200">
                                                                        <tr>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                ...
                                                                                <p class="text-xs text-gray-400"><?php echo $product->description; ?>
                                                                                </p>
                                                                            </td>
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                            ...
                                                                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                                                                <div class="flex space-x-4">
                                                                                    <a href="<?php echo URLROOT . '/Products/edit/' . $product->id ?>" class="text-blue-500 hover:text-blue-600">
                                                                                    ...
                                                                                    <a href="<?php echo URLROOT . '/Products/delete/'. $product->id ?>"  class="text-red-500 hover:text-red-600">
