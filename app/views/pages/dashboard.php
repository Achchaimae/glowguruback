            ...
            <div>
                <div class="text-white">
                    ...
                    <div class="flex justify-center">
                        <div class="">
                            <!-- admin img -->
                            <img class="hidden h-24 w-24 rounded-full sm:block object-cover mr-2 border-4 text-cyan-700"
                             
                                src="<?= URLROOT;?>/img/logo.png" alt="">
                    ...
                    <div>
                        <ul class="mt-6 leading-10">
                            <li class="relative px-2 py-1 ">
                                <a class="inline-flex items-center w-full text-sm font-semibold text-white transition-colors duration-150 cursor-pointer hover:text-cyan-700" 
                                    href="Dashboard">
                            ...
                            <li class="relative px-2 py-1" x-data="{ Open : false  }">
                                <div class="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                    ...
                                    <span
                                        class="inline-flex items-center  text-sm font-semibold text-white hover:text-cyan-700">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                            viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-show.transition="Open" style="display:none;">
                                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                                        ...
                                        class="p-2 mt-2 space-y-2 overflow-hidden text-sm font-medium  rounded-md shadow-inner  bg-cyan-700"
                                        aria-label="submenu">
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <button
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800 " onclick="show()">Products</button>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <button
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800" onclick="show()">Products
                                                    </button>
                                                </div>
                                            </div>
                                        </li>
            ...
            <header class="z-40 py-4  bg-gray-800  ">
                <div class="flex items-center justify-between h-8 px-6 mx-auto">
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button
                                class="p-2 bg-white text-cyan-700 align-middle rounded-full hover:text-white hover:bg-cyan-700 focus:outline-none "
                            ...
                            <template x-if="isNotificationsMenuOpen">
                                <ul x-transition:leave="transition ease-in duration-150"
                                    ...
                                    class="absolute right-0 w-56 p-2 mt-2 space-y-2 text-gray-600 bg-cyan-700 border border-cyan-700 rounded-md shadow-md">
                                    <li class="flex">
                            ...
                            <div class="col-span-12 mt-8">
                                ...
                                <div class="grid grid-cols-12 gap-6 mt-5">
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        ...
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                ...
                                                <div
                                                    class="bg-cyan-700 rounded-full h-6 px-2 flex justify-items-center text-white font-semibold text-sm">
                                    ...
                                    <a class="transform  hover:scale-105 transition duration-300 shadow-xl rounded-lg col-span-12 sm:col-span-6 xl:col-span-3 intro-y bg-white"
                                        ...
                                        <div class="p-5">
                                            <div class="flex justify-between">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7 text-cyan-700"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                                        stroke-width="2"
